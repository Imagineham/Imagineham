...
Part A:
  ...
  \item[]  OFFER               |   ACCEPT?    |      COMMENTS \\
  \item[]  $a_1$ to $b_1$      |   Yes        ||||   $a_1$, $b_1$ ENGAGED
  \item[]  $a_2$ to $b_4$      |   Yes        ||||   $a_2$, $b_4$ ENGAGED
  \item[]  $a_3$ to $b_1$      |   Yes        ||||   $a_3$, $b_1$ ENGAGED, $a_1$ is now FREE
  \item[]  $a_1$ to $b_4$      |   Yes        ||||   $a_1$, $b_4$ ENGAGED, $a_2$ is now FREE
  \item[]  $a_2$ to $b_3$      |   Yes        ||||   $a_2$, $b_3$ ENGAGED
  \item[]  $a_4$ to $b_3$      |   Yes        ||||   $a_4$, $b_3$ ENGAGED, $a_2$ is now FREE 
  \item[]  $a_2$ to $b_1$      |   Yes        ||||   $a_2$, $b_1$ ENGAGED, $a_3$ is now FREE
  \item[]  $a_3$ to $b_2$      |   Yes        ||||   $a_3$, $b_2$ ENGAGED \\ %at this point everyone is ENGAGED and in stable matchings    
...
Part B:
  ...
  \item[]  OFFER               |   ACCEPT?    |      COMMENTS \\
  \item[]  $b_1$ to $a_4$      |   Yes        ||||   $b_1$, $a_4$ ENGAGED
  \item[]  $b_2$ to $a_1$      |   Yes        ||||   $b_2$, $a_1$ ENGAGED
  \item[]  $b_3$ to $a_3$      |   Yes        ||||   $b_3$, $a_3$ ENGAGED
  \item[]  $b_4$ to $a_4$      |   No         ||||   $b_4$ is still FREE
  \item[]  $b_4$ to $a_3$      |   Yes        ||||   $b_4$, $a_3$ ENGAGED, $b_3$ is now FREE
  \item[]  $b_3$ to $a_1$      |   Yes        ||||   $b_3$, $a_1$ ENGAGED, $b_2$ is now FREE 
  \item[]  $b_2$ to $a_4$      |   No         ||||   $b_2$ is still FREE
  \item[]  $b_2$ to $a_2$      |   Yes        ||||   $b_2$, $a_2$ ENGAGED \\ %at this point everyone is ENGAGED and in stable matchings    
